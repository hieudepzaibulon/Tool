...
class zLocket:
    def __init__(self, device_token: str="", target_friend_uid: str="", num_threads: int=1, note_target: str=""):
        ...
        'https://api-bot.online/api/v3/proxy.txt',
        'https://thanhdieu.com/api/list/proxyv3.txt',
        'https://raw.githubusercontent.com/user/file/proxy_moi_12h_phucbaby.txt',
        'file://proxy.txt',
        'https://api-bot.online/api/v3/proxy.php?proxy_count=123'
    ]
